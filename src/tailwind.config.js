  ...
  theme: {
    ...
    colors: {
      ...
      blue: {
        ...
        400: '#63b3ed',
        500: '#4299e1',
        600: '#3271FC',  // Nova cor primary
        700: '#2F64DA',  // Novo azul incluído
        800: '#0346DA',  // Nova cor primary mais forte
        900: '#2a4365',
      },
      indigo: {
        100: '#ebf4ff',
    ...
    fontFamily: {
      display: ['Ubuntu', 'system-ui', '-apple-system', 'BlinkMacSystemFont', '"Segoe UI"', 'Roboto', '"Helvetica Neue"', 'Arial', '"Noto Sans"', 'sans-serif', '"Apple Color Emoji"', '"Segoe UI Emoji"', '"Segoe UI Symbol"', '"Noto Color Emoji"'],
    ...
    function ({ addUtilities }) {
      const newUtilities = {
        '.text-primary-gradient': {
          'background-image': 'linear-gradient(to right, #204699, #2D0798)',
