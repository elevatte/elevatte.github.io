...
const PrimaryBackgroundContainer = tw(Container)`-mx-8 px-8 font-black`;
...
const QuoteIcon = tw(QuoteIconBase)`absolute top-0 left-0 transform -translate-y-2 -translate-x-1/2 sm:-translate-x-full w-10 fill-current text-blue-700`
